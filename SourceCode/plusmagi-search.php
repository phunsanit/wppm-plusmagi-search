 ...
 * Plugin URI:  https://pitt.plusmagi.com/plugins/plusmagi-search
...
class PlusMagi_Search {
    ...
    public function render_admin_page() {
        ...
        <div class="wrap">
            ...
            <p>Thank you for using PlusMagi Search! This plugin provides a frontend search experience similar to the WordPress admin search, with role-based access control.</p>
            ...
            <div class="card">
                ...
                <p>
                    ...
                    <br>
                    <a href="https://pitt.plusmagi.com" target="_blank" style="font-size: 1.2em; text-decoration: none;">
                        <strong>Visit pitt.plusmagi.com &rarr;</strong>
                    </a>
                </p>
            </div>
        </div>
