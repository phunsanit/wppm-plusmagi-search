...
2. Upload `wp-search.zip` to your WordPress plugins page.
...
The output file will be located at `build/wp-search.zip`.
...
| Area | What is tested |
|------|---------------|
| Widget | Input visible, scripts enqueued, `wpSearch` object defined |
...
Yes, it is appropriate and secure. Logic has been implemented to strictly check user capabilities in `wp-search.php` (function `handle_search`) as follows:
